                            ...
                            <?php if ($is_logged_in): ?>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                        <a href="#" id="ubah-password">Ubah Password</a>
                                        <a href="#" id="ganti-foto">Ganti Foto</a>
                                        <a href="proses/logout.php">Logout</a> <!-- Link logout ke logout.php -->
                                    </div>
                                </div>
                            <?php else: ?>
        ...
        <img src="assets/images/logo.png" alt="Logo" id="login-logo">
            <form method="post" action="proses/register.php">
                <div class="form-element">
                    ...
                    <input type="text" id="username-register" name="username-register" placeholder="Masukkan Username" required>
                </div>
                <div class="form-element">
                    <label for="password-register">Password</label>
                    <input type="password" id="password-register" name="password-register" placeholder="Masukkan Password" required>
                </div>
                <div class="form-element">
                    <label for="confirm-password-register">Confirm Password</label>
                    <input type="password" id="confirm-password-register" name="confirm-password-register" placeholder="Confirm Password" required>
                </div>
                <div class="form-element">
