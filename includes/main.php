<main id="home">
    ...
    <section>
        <div class="container mt-3 mt-sm-5 mb-3 mb-sm-5">
            <div class="row align-items-center mb-3 mb-sm-5">
                ...
                <div class="col-md-6">
                    <h2 class="fw-bold">Bersama Ourecycle, sampah dirumah kamu bisa jadi uang dalam sekejap😎
                    </h2>
                    <p class="text-justify">Teknologi Ourecycle dirancang untuk mengelola sampah langsung dari
                        ...
                        Indonesia, sekaligus memberikan peluang untuk mengubah sampah menjadi penghasilan
                        tambahan.
                    </p>
                    <a href="#" class="btn" style="background-color: #33ac41; color: white; border: none;">Order
                        Layanan
                        Ourecycle!</a>
                </div>
            </div>
                ...
                <div class="col-md-4 mb-2 mb-sm-0">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Sampah milik pengguna akan diambil oleh OurTeam (karyawan
                                Ourecycle).
                            </p>
                        </div>
                    </div>
    ...
    <!-- Jenis Sampah -->
    <section id="jenisSampah">
        <div class="container mt-5">
            <h2 class="text-center">Jenis Sampah</h2>
            <p class="text-center">Lihat semua jenis sampah yang kami daur ulang.</p>
            <div class="row mt-4">
                <div class="col-md-4 mb-4">
                    <a href="jenis-sampah/kertas.php" class="card text-center text-decoration-none text-reset">
                        <div class="card-body">
