        ...
        <form action="process_submission.php" method="post" enctype="multipart/form-data" class="mb-3">
            ...
            <div class="mb-3" id="subjenisContainer" style="display: none;">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="subjenis1" name="subjenisSampah[]" value="plastik">
                    <label class="form-check-label" for="subjenis1">Plastik</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="subjenis2" name="subjenisSampah[]" value="kertas">
                    <label class="form-check-label" for="subjenis2">Kertas</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="subjenis3" name="subjenisSampah[]" value="logam">
            ...
            <div class="mb-3">
                ...
                <input type="file" id="fotoSampah" name="fotoSampah[]" class="form-control" accept="image/*" multiple required>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="position-relative">
                    <input type="text" id="alamat" name="alamat" class="form-control mb-3" required placeholder="Ketik untuk mencari alamat">
                ...
                <!-- Patokan Rumah -->
                <input type="text" id="patokanRumah" name="patokanRumah" class="form-control" placeholder="Masukkan patokan rumah">
            </div>
